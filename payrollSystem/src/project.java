...
public class project extends JFrame implements ActionListener {
    ...
    project(){
        ...
        ImageIcon i1 = new ImageIcon("E://payrollSystem/src/icon/payroll.jpg");
        ...
        t1.setIcon(new ImageIcon("E://payrollSystem/src/icon/New.png"));
        ...
        t3.setMnemonic('S');
        t3.setIcon(new ImageIcon("E://payrollSystem/src/icon/schedreport.png"));
        ...
        t4.setMnemonic('L');
        t4.setIcon(new ImageIcon("E://payrollSystem/src/icon/newinvoice.png"));
        ...
        s1.setMnemonic('U');
        s1.setIcon(new ImageIcon("E://payrollSystem/src/icon/EditOpen.png"));
        ...
        s2.setMnemonic('p');
        s2.setIcon(new ImageIcon("E://payrollSystem/src/icon/empreport.png"));
        ...
        s3.setMnemonic('T');
        s3.setIcon(new ImageIcon("E://payrollSystem/src/icon/EXPENSE.PNG"));
        ...
        p1.setMnemonic('P');
        p1.setIcon(new ImageIcon("E://payrollSystem/src/icon/payments.png"));
        ...
        p2.setMnemonic('L');
        p2.setIcon(new ImageIcon("E://payrollSystem/src/icon/empreport.png"));
        ...
        m8i1.setMnemonic('X');
        m8i1.setIcon(new ImageIcon("E://payrollSystem/src/icon/exit.PNG"));
